...
Únete a nuestro equipo! Porfavor entra la información siguiente así de esa manera podamos agregarte a nuestra lista de aplicante.
<form action="https://qrapply.goprovantage.com/index.php">
	<center><input type="submit" value="English"></center>
</form>
	...
	<form class="user" method="POST" action="<?=$_SERVER['REQUEST_URI']?>">
		<div class="form-group mb-3">
			<textArea type="name" class="form-control form-control-user" id="name" rows=1 name="name" maxlength=200 
				placeholder="Cual es tu nombre completo?" required style="width: 100%; max-width: 100%;"></textArea>
			<textArea type="phone" class="form-control form-control-user" id="phone" rows=1 name="phone" maxlength=200 
				placeholder="Cual es tu número de teléfono? xxx-xxx-xxxx" required style="width: 100%; max-width: 100%;"></textArea>
			<textArea type="address" class="form-control form-control-user" id="address" rows=1 name="address" maxlength=200 
				placeholder="Cual es tu dirección de domicilio?" required style="width: 100%; max-width: 100%;"></textArea>
			<textArea type="license" class="form-control form-control-user" id="license" rows=1 name="license" maxlength=200 
				placeholder="Cual es tu licencia de conducir?" required style="width: 100%; max-width: 100%;"></textArea>
			<textArea type="shift" class="form-control form-control-user" id="shift" rows=1 name="shift" maxlength=200 
				placeholder="Cuál es tu horario de preferencia?" required style="width: 100%; max-width: 100%;"></textArea>
			<textArea type="pay" class="form-control form-control-user" id="pay" rows=1 name="pay" maxlength=200 
				placeholder="Cuanto requieres de paga?" required style="width: 100%; max-width: 100%;"></textArea>				
		</div> 
